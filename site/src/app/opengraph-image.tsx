...
export const alt = 'motionType — Motion-adaptive typography for smart glasses'
	...
	return new ImageResponse(
		(
			<div style={{ background: '#0e0c12', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '72px 80px', fontFamily: 'Merriweather, serif' }}>
				<span style={{ fontSize: 13, letterSpacing: '0.18em', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase' }}>motiontype</span>
				...
				<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
					...
					<div style={{ fontSize: 13, color: 'rgba(255,255,255,0.18)', letterSpacing: '0.04em' }}>motiontype.com</div>
				</div>
			</div>
		),
