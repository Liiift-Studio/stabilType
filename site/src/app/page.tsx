					...
					<div className="flex flex-col gap-3">
						...
						<table className="w-full text-xs">
							...
							<tbody className="opacity-70">
								...
								<tr className="border-t border-white/10 hover:bg-white/5 transition-colors"><td className="py-2 pr-6 font-mono">slntAxis</td><td className="py-2 pr-6">&apos;slnt&apos;</td><td className="py-2">Variable font slant axis tag.</td></tr>
								<tr className="border-t border-white/10 hover:bg-white/5 transition-colors"><td className="py-2 pr-6 font-mono">liveBaseFVS</td><td className="py-2 pr-6">false</td><td className="py-2">When false (default), font-variation-settings is read from the computed cascade once on activation and cached — eliminating a getComputedStyle() call per frame. Set to true only if external CSS dynamically changes font-variation-settings on the element after stabilType has started.</td></tr>
